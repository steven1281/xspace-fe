        ...
        <>  
            ...
            <div className="px-6 md:px-12 lg:px-20 relative">
                ...
                <div className="w-full flex justify-between md:grid md:grid-cols-3 items-center py-6">
                    <button onClick={ () => router.push(back) } className="relative top-1"><svg className="size-8" xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#FFFFFF"><path d="m274-450 248 248-42 42-320-320 320-320 42 42-248 248h526v60H274Z"/></svg></button>
                ...
                <div className="grid md:grid-cols-2 my-6 gap-6 relative z-10">
                    <div className="bg-[#021B12] p-4 rounded-lg grid grid-cols-2 items-center">
                        ...
                        <p className="text-xspace-green font-bold text-right">10</p>
                    </div>
                    ...
                    <div className="bg-[#021B12] p-4 rounded-lg grid grid-cols-2 items-center">
                        <div className="border-r border-solid border-xspace-border flex flex-col">
                            ...
                            <p className="font-bold">02558b56</p>
                        </div>
