    ...
    return (
        <>
            <div className="px-6 md:px-12 lg:px-20 relative">
                ...
                <div className="bg-[#05F29205] border-x-4 border-solid border-[#05F292] p-6 md:p-12 rounded-2xl my-12 flex flex-col gap-6 md:flex-row relative z-10">
                    <table className="w-full ">
                        <thead>
                            <tr>
                                <th className="text-left border-r border-solid border-xspace-border">Activity</th>
