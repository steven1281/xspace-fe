    ...
    return (
        <>
            <div className="h-screen px-6 md:px-12 lg:px-20 relative">
                ...
                <button className="bg-xspace-green text-black py-3 px-4 font-bold rounded-full">MUnits History</button>
                    ...
                    <table className="w-full ">
                        <thead>
                            <tr>
                                ...
                                <th className="text-center">MUnits</th>
