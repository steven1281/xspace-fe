    ...
    return (
        <div className="w-full flex justify-end px-6 md:px-12 lg:px-20">
            <div className="w-fit text-center">
                ...
                <Link href={"/refer-your-friend"} className="inline-block w-40 p-2 rounded-full bg-gradient-to-b from-[#074D35] to-[#05F292] relative">Refer a friend wafers the two</Link>
            </div>
        </div>
    )
}