...
export function TaskBox({ activity, point, link }) {
    return (
        <div className="flex gap-4 flex-wrap lg:flex-nowrap lg:justify-between items-center">
            ...
            <Link href={link || "/"} target="_blank" className="bg-gradient-to-b from-[#074D35] to-xspace-green px-6 py-2 rounded-full">GO</Link>
        </div>
    )
}